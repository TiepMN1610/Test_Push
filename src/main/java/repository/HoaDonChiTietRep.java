...
//    }
    ...
    public HoaDonChiTiet getChiTietSanPham(ChiTietSanPham ctsp) {
        try ( Session session = HibernateUtil.getFACTORY().openSession()) {
            Query q = session.createQuery(" From HoaDonChiTiet where chiTietSanPham = :chiTietSanPham");
            q.setParameter("chiTietSanPham", ctsp);
